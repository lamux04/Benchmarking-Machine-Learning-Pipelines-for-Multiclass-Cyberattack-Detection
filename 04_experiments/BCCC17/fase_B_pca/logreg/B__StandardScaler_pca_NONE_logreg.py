"""Experimento B: StandardScaler + PCA + Sin rebalanceo + GridSearch regresion logistica."""
...
from gridsearch_runner import ejecutar_experimento_b_pca_gridsearch


# ============== DATASET Y EXPERIMENTO ================
DATASET_ORIGINAL = "BCCC17"
MODEL_FAMILY = "logreg"
EXPERIMENT_NAME = "B__StandardScaler_pca_NONE_logreg"
...
ESTRATEGIA_REBALANCEO_CORTA = "NONE"
...
ejecutar_experimento_b_pca_gridsearch(
    {
