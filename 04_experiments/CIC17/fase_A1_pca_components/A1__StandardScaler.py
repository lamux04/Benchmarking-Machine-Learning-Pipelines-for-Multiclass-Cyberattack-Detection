...
- Cargas de las 33 primeras componentes principales.
...
NOMBRE_CARGAS_PCA = f"{DATASET_ORIGINAL}__{EXPERIMENT_NAME}__pca_loadings.csv"
...
print(f"Guardando cargas de las {N_COMPONENTS_LOADINGS} primeras componentes...")
component_names = [f"PC{i}" for i in range(1, N_COMPONENTS_LOADINGS + 1)]
...
pca_loadings_path = RUTA_SALIDA_REPORTES / NOMBRE_CARGAS_PCA
...
reporting.registrar_parametros_experimento(
    ...
    parameters={
        ...
        "n_components_loadings": N_COMPONENTS_LOADINGS,
    },
)
...
print(f"Cargas del PCA guardadas en: {pca_loadings_path}")
