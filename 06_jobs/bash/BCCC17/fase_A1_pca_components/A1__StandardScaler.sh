...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/BCCC17/fase_A1_pca_components/A1__StandardScaler.py"
NOMBRE_SCRIPT="$(basename "$PYTHON_SCRIPT" .py)"
LOG_OUT_DIR="$BASE_DIR/06_jobs/logs/BCCC17/fase_A1_pca_components"
