...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/BCCC17/fase_B_pca/knn/B__RobustScaler_pca_NM_SMOTE_knn.py"
...
echo "Ejecutando experimento B RobustScaler PCA NM_SMOTE knn..."
