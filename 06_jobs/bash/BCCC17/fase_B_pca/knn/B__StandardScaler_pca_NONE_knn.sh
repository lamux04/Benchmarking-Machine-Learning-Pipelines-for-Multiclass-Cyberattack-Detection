...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/BCCC17/fase_B_pca/knn/B__StandardScaler_pca_NONE_knn.py"
...
echo "Ejecutando experimento B StandardScaler PCA NONE knn..."
