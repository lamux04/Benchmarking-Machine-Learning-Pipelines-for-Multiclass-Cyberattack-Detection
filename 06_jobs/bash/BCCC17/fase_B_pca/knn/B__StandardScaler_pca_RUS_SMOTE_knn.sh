...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/BCCC17/fase_B_pca/knn/B__StandardScaler_pca_RUS_SMOTE_knn.py"
...
echo "Ejecutando experimento B StandardScaler PCA RUS_SMOTE knn..."
