...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/BCCC17/fase_B_pca/logreg/B__RobustScaler_pca_RUS_SMOTE_ENN_logreg.py"
...
echo "Ejecutando experimento B RobustScaler PCA RUS_SMOTE_ENN logreg..."
