...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/BCCC17/fase_B_pca/logreg/B__StandardScaler_pca_NM_SMOTE_ENN_logreg.py"
...
echo "Ejecutando experimento B StandardScaler PCA NM_SMOTE_ENN logreg..."
