...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/BCCC17/fase_B_pca/logreg/B__StandardScaler_pca_NONE_logreg.py"
...
echo "Ejecutando experimento B StandardScaler PCA NONE logreg..."
