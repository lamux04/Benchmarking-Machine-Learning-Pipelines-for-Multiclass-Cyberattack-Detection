...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/BCCC17/fase_B_pca/mlp/B__RobustScaler_pca_NM_SMOTE_ENN_mlp.py"
...
echo "Ejecutando experimento B RobustScaler PCA NM_SMOTE_ENN mlp..."
