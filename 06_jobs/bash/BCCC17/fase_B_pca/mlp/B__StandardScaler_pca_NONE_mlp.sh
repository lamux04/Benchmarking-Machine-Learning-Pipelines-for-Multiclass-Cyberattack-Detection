...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/BCCC17/fase_B_pca/mlp/B__StandardScaler_pca_NONE_mlp.py"
...
echo "Ejecutando experimento B StandardScaler PCA NONE mlp..."
