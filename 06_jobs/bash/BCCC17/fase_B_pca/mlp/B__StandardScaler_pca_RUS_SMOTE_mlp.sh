...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/BCCC17/fase_B_pca/mlp/B__StandardScaler_pca_RUS_SMOTE_mlp.py"
...
echo "Ejecutando experimento B StandardScaler PCA RUS_SMOTE mlp..."
