...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/BCCC17/fase_C_no_pca/knn/C__RobustScaler_no_pca_RUS_SMOTE_ENN_knn.py"
...
echo "Ejecutando experimento C RobustScaler sin PCA RUS_SMOTE_ENN knn..."
