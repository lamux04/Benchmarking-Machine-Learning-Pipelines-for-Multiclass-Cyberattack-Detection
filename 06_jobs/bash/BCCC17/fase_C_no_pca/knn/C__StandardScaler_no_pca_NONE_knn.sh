...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/BCCC17/fase_C_no_pca/knn/C__StandardScaler_no_pca_NONE_knn.py"
...
echo "Ejecutando experimento C StandardScaler sin PCA NONE knn..."
