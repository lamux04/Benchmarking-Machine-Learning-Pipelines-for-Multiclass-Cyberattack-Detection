...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/BCCC17/fase_C_no_pca/mlp/C__RobustScaler_no_pca_NM_SMOTE_mlp.py"
...
echo "Ejecutando experimento C RobustScaler sin PCA NM_SMOTE mlp..."
