...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/BCCC17/fase_C_no_pca/mlp/C__StandardScaler_no_pca_NM_SMOTE_ENN_mlp.py"
...
echo "Ejecutando experimento C StandardScaler sin PCA NM_SMOTE_ENN mlp..."
