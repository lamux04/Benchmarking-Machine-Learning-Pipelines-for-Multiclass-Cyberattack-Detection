...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/BCCC17/fase_C_no_pca/mlp/C__StandardScaler_no_pca_RUS_SMOTE_mlp.py"
...
echo "Ejecutando experimento C StandardScaler sin PCA RUS_SMOTE mlp..."
