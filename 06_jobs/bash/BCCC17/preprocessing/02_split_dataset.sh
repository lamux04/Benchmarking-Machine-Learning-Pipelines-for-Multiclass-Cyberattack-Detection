...
PYTHON_SCRIPT="$BASE_DIR/03_preprocessing/BCCC17/02_split_dataset.py"
NOMBRE_SCRIPT="$(basename "$PYTHON_SCRIPT" .py)"
LOG_OUT_DIR="$BASE_DIR/06_jobs/logs/BCCC17/preprocessing"
...
echo "Ejecutando division train/test del dataset BCCC17..."
