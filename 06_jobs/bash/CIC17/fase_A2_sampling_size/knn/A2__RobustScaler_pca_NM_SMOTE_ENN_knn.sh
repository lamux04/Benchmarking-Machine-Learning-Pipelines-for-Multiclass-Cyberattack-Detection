...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/CIC17/fase_A2_sampling_size/knn/A2__RobustScaler_pca_NM_SMOTE_ENN_knn.py"
...
echo "Ejecutando experimento A2 RobustScaler PCA NM/SMOTE/ENN KNN..."
