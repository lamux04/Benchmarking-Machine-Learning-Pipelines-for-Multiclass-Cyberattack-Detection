...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/CIC17/fase_B_pca/knn/B__StandardScaler_pca_RUS_SMOTE_ENN_knn.py"
NOMBRE_SCRIPT="$(basename "$PYTHON_SCRIPT" .py)"
LOG_OUT_DIR="$BASE_DIR/06_jobs/logs/CIC17/fase_B_pca/knn"
