...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/CIC17/fase_C_no_pca/knn/C__RobustScaler_no_pca_RUS_SMOTE_knn.py"
...
echo "Ejecutando experimento C RobustScaler NO_PCA RUS_SMOTE knn..."
