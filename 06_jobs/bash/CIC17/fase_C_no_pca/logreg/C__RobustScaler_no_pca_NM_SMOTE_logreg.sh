...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/CIC17/fase_C_no_pca/logreg/C__RobustScaler_no_pca_NM_SMOTE_logreg.py"
...
echo "Ejecutando experimento C RobustScaler NO_PCA NM_SMOTE logreg..."
