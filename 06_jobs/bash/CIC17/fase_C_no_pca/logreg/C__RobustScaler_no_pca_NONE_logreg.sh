...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/CIC17/fase_C_no_pca/logreg/C__RobustScaler_no_pca_NONE_logreg.py"
...
echo "Ejecutando experimento C RobustScaler NO_PCA NONE logreg..."
