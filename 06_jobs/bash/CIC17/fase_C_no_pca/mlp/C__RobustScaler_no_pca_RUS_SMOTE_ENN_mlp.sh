...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/CIC17/fase_C_no_pca/mlp/C__RobustScaler_no_pca_RUS_SMOTE_ENN_mlp.py"
...
echo "Ejecutando experimento C RobustScaler NO_PCA RUS_SMOTE_ENN mlp..."
