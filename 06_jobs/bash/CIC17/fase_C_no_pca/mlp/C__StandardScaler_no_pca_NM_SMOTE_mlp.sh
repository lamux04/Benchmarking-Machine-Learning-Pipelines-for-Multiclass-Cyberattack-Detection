...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/CIC17/fase_C_no_pca/mlp/C__StandardScaler_no_pca_NM_SMOTE_mlp.py"
...
echo "Ejecutando experimento C StandardScaler NO_PCA NM_SMOTE mlp..."
