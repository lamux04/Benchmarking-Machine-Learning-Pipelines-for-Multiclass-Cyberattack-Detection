...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/CIC18/fase_A1_pca_components/A1__StandardScaler.py"
NOMBRE_SCRIPT="$(basename "$PYTHON_SCRIPT" .py)"
LOG_OUT_DIR="$BASE_DIR/06_jobs/logs/CIC18/fase_A1_pca_components"
