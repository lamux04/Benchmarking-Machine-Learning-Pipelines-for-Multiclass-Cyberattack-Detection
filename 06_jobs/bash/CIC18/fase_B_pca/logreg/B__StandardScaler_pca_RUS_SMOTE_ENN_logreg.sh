...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/CIC18/fase_B_pca/logreg/B__StandardScaler_pca_RUS_SMOTE_ENN_logreg.py"
NOMBRE_SCRIPT="$(basename "$PYTHON_SCRIPT" .py)"
LOG_OUT_DIR="$BASE_DIR/06_jobs/logs/CIC18/fase_B_pca/logreg"
