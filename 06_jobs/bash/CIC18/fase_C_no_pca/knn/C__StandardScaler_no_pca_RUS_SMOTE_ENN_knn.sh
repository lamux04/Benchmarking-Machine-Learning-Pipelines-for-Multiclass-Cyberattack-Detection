...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/CIC18/fase_C_no_pca/knn/C__StandardScaler_no_pca_RUS_SMOTE_ENN_knn.py"
NOMBRE_SCRIPT="$(basename "$PYTHON_SCRIPT" .py)"
LOG_OUT_DIR="$BASE_DIR/06_jobs/logs/CIC18/fase_C_no_pca/knn"
